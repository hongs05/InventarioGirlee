...
create index
if not exists orders_created_at_idx on public.orders
(created_at desc);
create index
if not exists orders_created_by_idx on public.orders
(created_by);
...
create index
if not exists order_product_items_order_idx on public.order_product_items
(order_id);
create index
if not exists order_product_items_product_idx on public.order_product_items
(product_id);
...
create index
if not exists order_combo_items_order_idx on public.order_combo_items
(order_id);
create index
if not exists order_combo_items_combo_idx on public.order_combo_items
(combo_id);
...
drop policy
if exists "Orders read" on public.orders;
...
drop policy
if exists "Orders insert" on public.orders;
...
drop policy
if exists "Orders update" on public.orders;
...
drop policy
if exists "Orders delete" on public.orders;
...
drop policy
if exists "Order product items read" on public.order_product_items;
...
drop policy
if exists "Order product items insert" on public.order_product_items;
...
drop policy
if exists "Order combo items read" on public.order_combo_items;
...
drop policy
if exists "Order combo items insert" on public.order_combo_items;
